          ...
          <nav data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fullwidth" data-lg-layout="rd-navbar-static" class="rd-navbar rd-navbar-default" data-stick-up-offset="50px" data-md-layout="rd-navbar-fullwidth" data-md-device-layout="rd-navbar-fullwidth" data-lg-device-layout="rd-navbar-static">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-nav-wrap">
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a href="index.php" class="brand-name"><img src="img/logo.png" alt="" width="158" height="50"></a></div>
                <!-- RD Navbar Nav-->
			  ...
			  <ul class="" id="myUL">
					...
					<div class="row icon-si ">
						<li><div class="col-md-4">	
								<a href="#"><img class="img-fluid" src="img/follow/whatsup.png">
								<span>Whatsup</span></a>
						</div></li>
						<li><div class="col-md-4">	
								<a href="#"><img class="img-fluid" src="img/follow/twitter.png">
								<span>twitter</span></a>
						</div></li>
						<li><div class="col-md-4">	
								<a href="#"><img class="img-fluid" src="img/follow/pinterest.png">
								<span>pinterest</span></a>
						</div></li>
					</div>
					<div class="row icon-si">
						<li><div class="col-md-4">	
								<a href="#"><img class="img-fluid" src="img/follow/gplus.png">
								<span>Google plus</span></a>
						</div></li>
						<li><div class="col-md-4">	
								<a href="#"><img class="img-fluid" src="img/follow/face.png">
								<span>Facebook</span></a>
						</div></li>
						<li><div class="col-md-4">	
								<a href="#"><img class="img-fluid" src="img/follow/email.png">
								<span>Email</span></a>
						</div></li>
					</div>	
					<div class="row icon-si">
