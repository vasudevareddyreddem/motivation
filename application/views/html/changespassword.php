            ...
            <div class="cell-sm-12  cell-md-6  col-md-offset-3">
              <div class="box">
                ...
                <div class="section-30 inset-left-15 inset-right-15 inset-md-left-30 inset-md-right-30">
                  ...
                  <form  method="POST" action="<?php echo base_url('motivation/changepwdpost'); ?>">
                    <input class="form-control" type="password" id="oldpassword" name="oldpassword"  placeholder="Old Password" required><br> 
                    <input class="form-control" type="password" id="password" name="password"  placeholder="Password" required><br> 
					<input class="form-control" type="password" id="confirmpassword" name="confirmpassword" placeholder="Confirm Password " required><br> 
